...
export default function LandingScreen({
  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      {/* Navigation */}
      <header className="border-b border-b-gray-200 fixed w-full bg-background bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-40 z-50">
